...
link-citations: yes
repository_url: https://github.com/n8craig/ICE-detention-daily
...
```{r load-dataset}
# Load Dataset
df_summary <- read_csv(here::here("data/covid_summaries.csv"), 
...
```{r ICE-Detention-Population, fig.cap="ICE detention population plotted over time. Data source: https://www.ice.gov/coronavirus"}
...
# Appendix A: Static plot of total detained population {#appendix-a .unnumbered}
